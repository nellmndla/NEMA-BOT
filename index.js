...
/////////////////
const BotName = 'NEMA BOT☄'; 
const instagram = 'https://instagram.com/nellmndlaa_'; 
const telegram = 'https://t.me/nellmndla'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCZDr3AW--n0zNl5EW0AzZNQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@nellmndlaa_')
